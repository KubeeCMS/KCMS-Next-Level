jQuery(function() {
    ...
    var isMobileTablet = client.getDeviceType() == 'mobile' || client.getDeviceType() == 'tablet';
    ...
    if (isMobileTablet) {
        ...
        if (objectName.settings.pwaOverlays == 'on') {
            ...
            if (objectName.settings.pwaOverlaysSkip == 'on' && isFirstVisit == null) {
                ...
                if (!sessionStorage.getItem('firstVisit')) {
                    ...
                    if (objectName.settings.pwaOverlaysTypeFullscreen == 'on' && !isPwa() && !isFacebookApp() && isFullscreenOverlayShown == null && fullscreenOverlay.length) {
                    ...
                    if (objectName.settings.pwaOverlaysTypeHeader == 'on' && !isPwa() && !isFacebookApp() && isHeaderOverlayShown == null && headerOverlay.length) {
                    ...
                    if (objectName.settings.pwaOverlaysTypeSnackbar == 'on' && !isPwa() && !isFacebookApp() && isSnackbarOverlayShown == null && snackbarOverlay.length) {
                        if (objectName.settings.pwaOverlaysBrowsers.includes('chrome') && isAndroidChrome) {
                    ...
                    if (objectName.settings.pwaOverlaysTypePost == 'on' && !isPwa() && !isFacebookApp() && isPostOverlayShown == null && postOverlay.length) {
                        if (objectName.settings.pwaOverlaysBrowsers.includes('chrome') && isAndroidChrome) {
                    ...
                    if (objectName.settings.pwaOverlaysTypeMenu == 'on' && !isPwa() && !isFacebookApp() && isMenuOverlayShown == null && menuOverlay.length) {
                        if (objectName.settings.pwaOverlaysBrowsers.includes('chrome') && isAndroidChrome) {
                    ...
                    if (objectName.settings.pwaOverlaysTypeFeed == 'on' && !isPwa() && !isFacebookApp() && isFeedOverlayShown == null && feedOverlay.length) {
                        if (objectName.settings.pwaOverlaysBrowsers.includes('chrome') && isAndroidChrome) {
                    ...
                    if (objectName.settings.pwaOverlaysTypeCheckout == 'on' && !isPwa() && !isFacebookApp() && isCheckoutOverlayShown == null && checkoutOverlay.length) {
                        if (objectName.settings.pwaOverlaysBrowsers.includes('chrome') && isAndroidChrome) {
        ...
        if (objectName.settings.pwaInstallButton == 'on') {
            if (!isPwa() && !isFacebookApp() && installButton.length) {
